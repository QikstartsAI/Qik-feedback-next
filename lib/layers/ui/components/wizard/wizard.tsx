...
import handleSubmitFeedback, {
  formattedName,
} from "@/lib/lib/handleSubmitFinal";
import { findCustomerFeedbackDataInBusiness } from "@/lib/lib/handleEmail";
import { getImprovements } from "@/lib/constants/form";
    ...
    <div className="mt-10 w-full flex justify-center px-4">
      {!clientType ? (
        ...
        <div className="flex flex-col">
          ...
          />
          {/* Keep the rest commented for now */}
          <Form
            autoComplete="on"
            form={form}
            name="validateOnly"
