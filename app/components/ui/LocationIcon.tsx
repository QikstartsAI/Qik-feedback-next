...
const LocationIcon = ({ color }: { color?: string }) => {
  ...
  return (
    <svg
      ...
      version="1.1"
      viewBox="0 0 312 407.9"
      className="animate-bounce delay-100 w-[150px] h-[150px]"
    >
      <defs>
        <style>
          {`.cls-1 {
