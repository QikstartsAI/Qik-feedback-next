...
const SimpleContactInfo = ({ form, feedbackType }: SimpleContactInfoProps) => {
  ...
  return (
    <div className="p-10">
      {isInspection ? <InspectionFeedbackHeader /> : <SimpleFeedbackHeader />}
      <FormField
          ...
          <FormItem className="mt-4">
            <FormLabel className="text-xl font-semibold">
              ...
              <span className="text-xs text-gray-400 font-normal">
                {isInspection ? "(Mandatory)" : "(important but optional)"}
              </span>
            </FormLabel>
            <FormControl>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="mt-4">
            <FormLabel className="text-xl font-semibold">
              Share details about{" "}
              {isInspection ? "this inspection" : "your experience"}{" "}
              <span className="text-xs text-gray-400 font-normal">
                (mandatory)
              </span>
            </FormLabel>
            <FormControl>
              <Textarea placeholder="It was good but..." {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <Button
        ...
        type="submit"
        disabled={!isTermsChecked ? true : form.formState.isSubmitting}
      >
        Send
      </Button>
