...
const getNextButton = ({ businessCountry }: { businessCountry: string }) => {
  return nextButton[businessCountry as keyof typeof nextButton] || nextButton.default
}

const getYesButton = ({ businessCountry }: { businessCountry: string }) => {
  return yesButton[businessCountry as keyof typeof yesButton] || yesButton.default
}
...
const getRecommendingPlaceholder = ({ businessCountry }: { businessCountry: string }) => {
  return recommendingPlaceholder[businessCountry as keyof typeof recommendingPlaceholder] || recommendingPlaceholder.default
}

const getNoRecommendingPlaceholder = ({ businessCountry }: { businessCountry: string }) => {
  return noRecommendingPlaceholder[businessCountry as keyof typeof noRecommendingPlaceholder] || noRecommendingPlaceholder.default
}

const getSubmitText1 = ({ businessCountry }: { businessCountry: string }) => {
  return submitText1[businessCountry as keyof typeof submitText1] || submitText1.default
}

const getSubmitText2 = ({ businessCountry }: { businessCountry: string }) => {
  return submitText2[businessCountry as keyof typeof submitText2] || submitText2.default
}

const getSubmitText3 = ({ businessCountry }: { businessCountry: string }) => {
  return submitText3[businessCountry as keyof typeof submitText3] || submitText3.default
}

const getSubmitText4 = ({ businessCountry }: { businessCountry: string }) => {
  return submitText4[businessCountry as keyof typeof submitText4] || submitText4.default
}

const getSubmitText5 = ({ businessCountry }: { businessCountry: string }) => {
  return submitText5[businessCountry as keyof typeof submitText5] || submitText5.default
}

const getToImproveText = ({ businessCountry }: { businessCountry: string }) => {
  return toImproveText[businessCountry as keyof typeof toImproveText] || toImproveText.default
}

const getFoodButton = ({ businessCountry }: { businessCountry: string }) => {
  return foodButton[businessCountry as keyof typeof foodButton] || foodButton.default
}

const getServiceButton = ({ businessCountry }: { businessCountry: string }) => {
  return serviceButton[businessCountry as keyof typeof serviceButton] || serviceButton.default
}

const getAmbienceButton = ({ businessCountry }: { businessCountry: string }) => {
  return ambienceButton[businessCountry as keyof typeof ambienceButton] || ambienceButton.default
}

const getShareDetailsText = ({ businessCountry }: { businessCountry: string }) => {
  return shareDetailsText[businessCountry as keyof typeof shareDetailsText] || shareDetailsText.default
}

const getShareDetailsPlaceholder = ({ businessCountry }: { businessCountry: string }) => {
  return shareDetailsPlaceholder[businessCountry as keyof typeof shareDetailsPlaceholder] || shareDetailsPlaceholder.default
}
...
const getFormTranslations = ({ businessCountry }: { businessCountry: string }) => {
  ...
  return {
    ...
    noRecommendingPlaceholder: getNoRecommendingPlaceholder({ businessCountry }),
